        ...
        <Grid container spacing={3}>
            ...
            <ul style={{ listStyleType: "none", padding: 0, margin: 0 }}>
              ...
              <li>
                <Link
                  ...
                  style={{ display: "flex", alignItems: "center" }}
                >
                  <Phone style={{ marginRight: "5px" }} /> Phone: +91 9099909941
                </Link>
              </li>
              <li>
                <Link
          ...
          <Grid item xs={12} md={3}>
            <ul style={{ listStyleType: "none", padding: 0, margin: "20px" }}>
              ...
              <li>
                <Link href="apply-now" color="inherit" sx={linkStyle}>
                  <i className="fa fa-angle-right" /> Apply Now
                </Link>
              </li>
              <li>
                <Link href="repay-now" color="inherit" sx={linkStyle}>
                  <i className="fa fa-angle-right" /> Repay Now{" "}
                </Link>
              </li>
              <li>
