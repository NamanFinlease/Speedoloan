...
const LoanForm = () => {
  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case "mobile":
        tempErrors.mobile =
          /^\d{10}$/.test(value) || !value ? "" : "Mobile number must be 10 digits";
        break;
      case "email":
        tempErrors.email =
          /\S+@\S+\.\S+/.test(value) || !value ? "" : "Please enter a valid email address";
        break;
      case "pinCode":
        tempErrors.pinCode =
      ...
      {showModal && (
        <div style={modalOverlayStyle}>
          <div style={modalContentStyle}>
            ...
            <p>Our executive will connect with you soon.</p>
