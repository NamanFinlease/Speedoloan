...
const TermsAndConditions = () => {
 ...
 '&:hover': { transform: 'scale(1.05)' } }}>
            <Typography 
                ...
                sx={{ fontWeight: 'bold' }}
            >
                Welcome to Speedoloan.com, a website operated by Naman Finlease Private Limited. These Terms and Conditions ("Terms") govern your access to and use of our platform and services. By using Speedoloan.com, you agree to comply with and be bound by these Terms. If you do not agree, please discontinue using our services.
        ...
        <Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
            ...
            <Typography>
                Speedoloan.com is a digital platform designed to offer personal loans to salaried individuals. All loans provided through this platform are processed and disbursed by Naman Finlease Private Limited, a Non-Banking Financial Company (NBFC) registered with the Reserve Bank of India (RBI). These Terms apply to any interaction you have with Speedoloan.com, including accessing the website, applying for loans, and managing your loan account.
            </Typography>
        </Box>
        ...
        <Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
            ...
            <Typography>
                By using Speedoloan.com, you confirm that:
            </Typography>
            <ul>
        ...
        <Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
            ...
            <Typography>
                To apply for a loan via Speedoloan.com, users must complete the following steps:
            </Typography>
            <ul>
                ...
                <li>Approval: The approval of any loan is at the sole discretion of Naman Finlease Private Limited. Multiple factors, including your credit score, employment details, and financial history, will be considered during the approval process.</li>
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <ul>
        ...
        <li>Payment Methods: You must repay the loan using the payment methods available on Speedoloan.com. These may include NACH (National Automated Clearing House), debit instructions, UPI, net banking, or other methods specified by us.</li>
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <ul>
        ...
        <li>Processing Fees: Speedoloan.com may charge a processing fee, which will be deducted from the loan amount before disbursal.</li>
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <ul>
        <li>By using Speedoloan.com, you agree to provide accurate, complete, and truthful information during the loan application process.</li>
        ...
        <li>Refrain from using Speedoloan.com for fraudulent or unlawful activities.</li>
    </ul>
</Box>
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <Typography>
        We collect personal information for the purpose of processing loan applications, performing credit checks, and offering tailored financial solutions. By using Speedoloan.com, you agree to the collection, storage, and use of your data as outlined in our Privacy Policy.
    </Typography>
    <ul>
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <Typography>
        Speedoloan.com may use third-party service providers for activities like credit checks, payment processing, and identity verification. We do not share your personal data with third parties without your consent, except as necessary to provide our services or comply with legal obligations.
    </Typography>
    <ul>
        ...
        <li>Bank Partners: Speedoloan.com may work with banking partners to facilitate loan disbursal and repayments.</li>
    </ul>
</Box>
<Divider sx={{ my: 2 }} />
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <Typography>
        Speedoloan.com takes appropriate security measures to protect your personal and financial data. This includes the use of encryption, secure servers, and access controls. However, no system is completely secure, and we cannot guarantee the absolute security of your data.
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <Typography>
        Speedoloan.com reserves the right to terminate or suspend your access to the platform under the following circumstances:
        <ul>
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <Typography>
        <ul>
            <li>Speedoloan.com provides its services on an "as is" and "as available" basis. While we strive for accuracy, we do not warrant that our platform will be free from errors, interruptions, or security breaches.</li>
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <Typography>
        To the fullest extent permitted by law, Speedoloan.com and Naman Finlease Private Limited shall not be liable for any indirect, incidental, or consequential damages arising out of your use of the platform or any loan-related issues, including, but not limited to:
        <ul>
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <Typography>
        These Terms and Conditions are governed by the laws of India. Any disputes arising out of or related to these Terms or the use of Speedoloan.com shall be subject to the exclusive jurisdiction of the courts in New Delhi, India.
    </Typography>
</Box>
...
<Box sx={{ transition: 'transform 0.3s ease-in-out', '&:hover': { transform: 'scale(1.05)' } }}>
    ...
    <ul>
        <li>Email: [info@Speedoloan.com]</li>
...
<Typography>
    By using Speedoloan.com, you acknowledge that you have read, understood, and agree to these Terms and Conditions. Thank you for choosing us as your business loan partner.
</Typography>
                </Paper>
            </Container>
