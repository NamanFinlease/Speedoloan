  ...
  const sections = [
    {
      ...
      content: [
        "Speedo Loan is a digital platform designed to offer personal loans to salaried individuals. All loans provided through this platform are processed and disbursed by  AGRIM FINCAP PRIVATE LIMITED, a Non-Banking Financial Company (NBFC) registered with the Reserve Bank of India (RBI). These Terms apply to any interaction you have with Speedo Loan, including accessing the website, applying for loans, and managing your loan account.",
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        "To the fullest extent permitted by law, Speedo Loan and AGRIM FINCAP PRIVATE LIMITED shall not be liable for any indirect, incidental, or consequential damages arising out of your use of the platform or any loan-related issues, including, but not limited to:",
